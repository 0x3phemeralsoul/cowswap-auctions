...
def main():
    ...
    calldata_query = text("SELECT * from call_data where call_data.solutionId not in (SELECT call_data_clearing_prices.solution_id from call_data_clearing_prices)")
